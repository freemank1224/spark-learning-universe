...
const CourseSidebar = ({ tasks, achievements }: CourseSidebarProps) => {
  return (
    <section className="course-sidebar w-full md:w-1/5 bg-theme-dark/90 backdrop-blur-md border-r border-theme-stone/20">
      <div className="h-full overflow-y-auto" style={{ maxHeight: '100vh' }}>
